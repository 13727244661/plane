...
class GameState:
    ...
    def __init__(self):
        ...
        enemy_img_config=pygame.image.load('game/enemy1.png')
        enemy_dowm=pygame.image.load('game/enemy1_down2.png')
        ...
        self.enemy1_rect = enemy_img_config.get_rect()
        self.enemy1_img = enemy_img_config.subsurface(self.enemy1_rect)
        self.enemy1_down_imgs = enemy_dowm.subsurface(enemy_dowm.get_rect())
        #存储敌机，管理多个对象
    ...
    def frame_step(self, input_actions):
        ...
        ''' background = pygame.image.load("game/background.png").convert()
        # 缩放背景图片以适应游戏界面大小
